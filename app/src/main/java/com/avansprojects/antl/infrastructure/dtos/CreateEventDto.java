...
public class CreateEventDto {
     ...
     * @param externalId
     */
    public CreateEventDto(String externalId, String name, String description, String imagePath, Date mainDateTime, String location, List<EventDateDto> eventDates, boolean isOwner) {
        super();
